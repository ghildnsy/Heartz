...
- [x] **Inisialisasi Server & RESTful API:** Membuat repositori lokal, inisialisasi lingkungan Node.js, menginstal Express.js, dan menyusun kerangka direktori (`routes`, `controllers`, `middlewares`).
